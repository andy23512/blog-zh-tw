...
alias:
  ...
  - /2024/03/26/tangent-的最新和弦列表/
  - /2024/03/27/tangent-的最新和弦列表/
  - /2024/03/28/tangent-的最新和弦列表/
  - /2024/03/29/tangent-的最新和弦列表/
otherLanguages:
  - text: English Version
    path: https://andy23512.com/blog/tangent-s-latest-chord-list/
---
{% blockquote %}
...
註 2：我最新的和弦備份檔案在[這裡](https://raw.githubusercontent.com/andy23512/setting-files/master/CharaChorder/chords.json)。
...
|c+o+n|container|"container" 是我全端工作上常用到的字。|
...
|d+j|django|[Django](https://www.djangoproject.com/) 是我在全端工作上所用的網頁框架。|
|d+k|docker|[Docker](https://www.docker.com/) 是一個開放平臺軟體，用於開發、交付和執行應用程式。我全端工作上會用到。|
...
|p+n|preference|"preference" 是我全端工作上常用的字。|
...
|v+i|viewer|"viewer" 是我全端工作上常用到的字。|
|w+r|Warranty Replacement|這是我客服工作上常用到的詞。|
