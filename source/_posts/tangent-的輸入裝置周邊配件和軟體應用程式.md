...
otherLanguages:
  - text: English Version
    path: https://andy23512.gitlab.io/blog/tangent-s-accessories-and-software-applications-used-with-input-devices/
hackMDUrl: https://hackmd.io/@andy23512/H1kg-k_Ikl
---
## 配件
...
我有高膽固醇問題，原因應該是一天中有大部分時間都在電腦前久坐所導致。為了健康著想，我選擇在站立工作桌上放我的 CC2，在使用電腦時交替坐站姿勢。

我買的是[這個站立桌](https://store.raymii.com.tw/products/raymii-vn3-sit-stand-desk)，並把兩個擋板替換成上面提到的鍵盤架的扶手靠。

但它的寄送地點僅限台灣。你或許可以在其他公司找到可以運送到你所在的國家的類似產品。
