...
updated: 2026-07-23T11:54:00.523Z
categories: [筆記, 比較]
alias:
...
| **底板**                             | 3D 列印塑膠[^m4g_base_material]                                                                                                      | 不適用[^ccu_externals_dependence]                                                                              | 3D 列印塑膠    | 3D 列印塑膠[^cc2_half_material]                                                     | 射出成型 ABS 塑膠[^cc1_half_material]                                               | ABS 塑膠[^ccl_base_material]                                                       | 不適用                                                                       | 不適用                                     | ???                        |
| **鍵帽**                             | 模壓紋理橡膠[^m4g_key_cap]                                                                                                            | 不適用[^ccu_externals_dependence]                                                                              | 模壓紋理橡膠    | 橡膠 X 型環 + 3D 列印塑膠                                                                        | 噴砂鋁和 ABS 塑膠                                                                   | ???                                                                                | 不適用                                                                          | ???                                        | ???                        |
