...
(I wrote {% post_link tangent-s-layout-for-using-bopomofo-chinese-input-method-with-charachorder-one the detail about the whole design and implementation of my Bopomofo input method in this article %}.)
